...
import webapp from '../images/customize.svg';
      ...
      <div className="container">
        <div className="row">
          <div className="col-10 mb-50 mx-auto">
            ...
            <div className="row gy-4 mycard">
              <div className="col-10 col-md-4 mx-auto">
                <div className="card mt-50">
                  <img src={webapp} className="card-img-top" alt="CardImg1" />
                  <div className="card-body">
                    <h5 className="card-title">Customization</h5>
                    <p className="card-text">Put your info & customize it as you want. Your Choice can be reached easily with our Code. It's You who build.</p>
